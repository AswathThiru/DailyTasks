...
class Branch extends College {
    ...
    public Branch(String collegeName, int collegeId, String collegeAd, String branchName, int branchId,
            int branchStaffNo) {
...
public class Student extends Branch {
    ...
    public Student(String collegeName, int collegeId, String collegeAd, String branchName, String studentName,
            int studentId, Long phoneNo) {
    ...
    public static void main(String[] args) {
        Student S1 = new Student("Skcet", 100, "Coimbatore", "Kuniyamuthur", "Aswath", 21, 1234567890l);
